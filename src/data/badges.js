...
export const BADGES = [
  ...
  {
    id: 'calypso-2', days: 85, tier: 5, tierName: 'Minor Deity',
    name: 'Tiresias', role: 'The Blind Prophet',
    emoji: '🔮',
    color: 'from-slate-500 to-indigo-600',
    bg: 'bg-slate-50', border: 'border-slate-200', text: 'text-slate-700',
    lore: "Tiresias, the blind seer of the Underworld, was the only soul who could chart Odysseus's path home. At 85 days, your foresight and discipline have become your own kind of prophecy.",
  },

  // ── TIER 6: The Twelve Olympians ─────────────────────────── days 90–145
  {
    id: 'hermes', days: 90, tier: 6, tierName: 'Olympian God',
    name: 'Hermes', role: 'Messenger of the Gods',
    emoji: '✉️',
    color: 'from-amber-400 to-yellow-500',
    bg: 'bg-amber-50', border: 'border-amber-200', text: 'text-amber-700',
    lore: "Hermes, swift messenger of Olympus, carried divine knowledge across the cosmos. You've carried your knowledge forward for 90 days. Swift, consistent, divine.",
  },
  {
    id: 'dionysus', days: 95, tier: 6, tierName: 'Olympian God',
    name: 'Dionysus', role: 'God of Festivity & Renewal',
    emoji: '🍇',
    color: 'from-purple-500 to-fuchsia-600',
    bg: 'bg-purple-50', border: 'border-purple-200', text: 'text-purple-700',
    lore: "Dionysus taught that even the gods need celebration after labor. At 95 days, you've earned the right to celebrate — your hard work has more than paid off.",
  },
  {
    id: 'hephaestus', days: 100, tier: 6, tierName: 'Olympian God',
    name: 'Hephaestus', role: 'God of the Forge',
    emoji: '🔨',
    color: 'from-orange-500 to-red-600',
    bg: 'bg-orange-50', border: 'border-orange-200', text: 'text-orange-700',
    lore: "Hephaestus forged armor and wonders with patient, steady hands. 100 days of daily effort — you've hammered your knowledge into something unbreakable.",
  },
  {
    id: 'ares', days: 105, tier: 6, tierName: 'Olympian God',
    name: 'Ares', role: 'God of War',
    emoji: '🛡️',
    color: 'from-red-600 to-rose-700',
    bg: 'bg-red-50', border: 'border-red-200', text: 'text-red-700',
    lore: "Ares charged into every battle without hesitation. At 105 days, you've shown that same fearlessness — facing every tough question head-on.",
  },
  {
    id: 'apollo', days: 110, tier: 6, tierName: 'Olympian God',
    name: 'Apollo', role: 'God of Light, Music & Knowledge',
    emoji: '☀️',
    color: 'from-yellow-400 to-orange-500',
    bg: 'bg-yellow-50', border: 'border-yellow-200', text: 'text-yellow-700',
    lore: "Apollo, god of truth and enlightenment, illuminated the path for mortals and gods alike. After 110 days, your own light of knowledge shines brilliantly.",
  },
  {
    id: 'artemis', days: 115, tier: 6, tierName: 'Olympian God',
    name: 'Artemis', role: 'Goddess of the Hunt & the Moon',
    emoji: '🏹',
    color: 'from-emerald-500 to-teal-600',
    bg: 'bg-emerald-50', border: 'border-emerald-200', text: 'text-emerald-700',
    lore: "Artemis never missed her mark, tracking her quarry with focus and precision across any terrain. 115 days — your aim and consistency are just as true.",
  },
  {
    id: 'aphrodite', days: 120, tier: 6, tierName: 'Olympian God',
    name: 'Aphrodite', role: 'Goddess of Love & Beauty',
    emoji: '🌹',
    color: 'from-pink-500 to-rose-500',
    bg: 'bg-pink-50', border: 'border-pink-200', text: 'text-pink-700',
    lore: "Aphrodite found beauty and grace in all things. After 120 days, you've found the same in the steady rhythm of showing up for yourself, day after day.",
  },
  {
    id: 'demeter', days: 125, tier: 6, tierName: 'Olympian God',
    name: 'Demeter', role: 'Goddess of the Harvest',
    emoji: '🌾',
    color: 'from-lime-500 to-green-600',
    bg: 'bg-lime-50', border: 'border-lime-200', text: 'text-lime-700',
    lore: "Demeter's patient care made the seasons turn and the fields grow. At 125 days, your patient daily care has finally come into harvest — look how far you've grown.",
  },
  {
    id: 'athena', days: 130, tier: 6, tierName: 'Olympian God',
    ...
    lore: "Athena guided Odysseus's every step. She is the patron of science, strategy, and wisdom. At 130 days you've earned her blessing. She looks upon you with pride.",
  },
  {
    id: 'hera', days: 135, tier: 6, tierName: 'Olympian God',
    name: 'Hera', role: 'Queen of the Gods',
    emoji: '👑',
    color: 'from-violet-600 to-purple-700',
    bg: 'bg-violet-50', border: 'border-violet-300', text: 'text-violet-700',
    lore: "Hera ruled Olympus with unwavering authority and resolve. At 135 days, your own resolve has carried you to a place of true command over your studies.",
  },
  {
    id: 'poseidon', days: 140, tier: 6, tierName: 'Olympian God',
    name: 'Poseidon', role: 'God of the Sea',
    emoji: '🌊',
    color: 'from-blue-600 to-cyan-700',
    bg: 'bg-blue-50', border: 'border-blue-300', text: 'text-blue-700',
    lore: "Poseidon threw storm after storm at Odysseus — and still Odysseus sailed on. You've weathered 140 days of your own storms and kept going. Even the sea bows to you now.",
  },
  {
    id: 'zeus', days: 145, tier: 6, tierName: 'Olympian God',
    name: 'Zeus', role: 'King of the Gods',
    emoji: '⚡',
    color: 'from-yellow-500 to-amber-600',
    bg: 'bg-yellow-50', border: 'border-yellow-300', text: 'text-yellow-800',
    lore: '145 days. The Fates themselves mark this moment. Zeus, ruler of Olympus, watches from above and nods. You have earned the highest badge. The gods themselves are impressed.',
  },
]
